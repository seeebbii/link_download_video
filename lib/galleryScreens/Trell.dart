...
final Directory _videoDir = new Directory('/data/user/0/com.codeminers.link_download_video/app_flutter/trell/');
class Trell extends StatefulWidget {
  @override
  _TrellState createState() => _TrellState();
}

class _TrellState extends State<Trell> {
    ...
    if(!Directory("${_videoDir.path}").existsSync()) {
      return Scaffold(
        ...
        body: Container(
          ...
          child: Center(
            child: Text("Install Trell.", style: TextStyle(
                fontSize: 18.0
            ),),
          ),
        ),
