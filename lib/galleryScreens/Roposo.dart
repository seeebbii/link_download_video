...
final Directory _videoDir = new Directory('/data/user/0/com.codeminers.link_download_video/app_flutter/roposo/');
class Roposo extends StatefulWidget {
  @override
  _RoposoState createState() => _RoposoState();
}

class _RoposoState extends State<Roposo> {
    ...
    if(!Directory("${_videoDir.path}").existsSync()) {
      return Scaffold(
        ...
        body: Container(
          ...
          child: Center(
            child: Text("Install Roposo.", style: TextStyle(
                fontSize: 18.0
            ),),
          ),
        ),
