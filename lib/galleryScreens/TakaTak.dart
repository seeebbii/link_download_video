...
final Directory _videoDir = new Directory('/data/user/0/com.codeminers.link_download_video/app_flutter/takatak/');
class TakaTak extends StatefulWidget {
  @override
  _TakaTakState createState() => _TakaTakState();
}

class _TakaTakState extends State<TakaTak> {
    ...
    if(!Directory("${_videoDir.path}").existsSync()) {
      return Scaffold(
        ...
        body: Container(
          ...
          child: Center(
            child: Text("Install Taka Tak.", style: TextStyle(
                fontSize: 18.0
            ),),
          ),
        ),
