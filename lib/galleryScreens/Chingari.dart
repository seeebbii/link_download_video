...
final Directory _videoDir = new Directory('/data/user/0/com.codeminers.link_download_video/app_flutter/chingari/');
    ...
    if(!Directory("${_videoDir.path}").existsSync()) {
      return Scaffold(
        ...
        body: Container(
          ...
          child: Center(
            child: Text("Install Chingari.", style: TextStyle(
                fontSize: 18.0
            ),),
          ),
        ),
