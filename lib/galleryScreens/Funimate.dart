...
final Directory _videoDir = new Directory('/data/user/0/com.codeminers.link_download_video/app_flutter/funimate/');
class Funimate extends StatefulWidget {
  @override
  _FunimateState createState() => _FunimateState();
}

class _FunimateState extends State<Funimate> {
    ...
    if(!Directory("${_videoDir.path}").existsSync()) {
      return Scaffold(
        ...
        body: Container(
          ...
          child: Center(
            child: Text("Install Funimate.", style: TextStyle(
                fontSize: 18.0
            ),),
          ),
        ),
